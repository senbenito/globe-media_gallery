...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Galleria_js__ = __webpack_require__("./components/Galleria.js");
...
var galleriaTheme = function galleriaTheme() {
  return __WEBPACK_IMPORTED_MODULE_3__components_Galleria_js__["a" /* default */].loadTheme('https://cdnjs.cloudflare.com/ajax/libs/galleria/1.5.7/themes/classic/galleria.fullscreen.min.js').run('.galleria', {
    transition: 'fade',
    imageCrop: true
  });
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return __WEBPACK_IMPORTED_MODULE_4_isomorphic_unfetch___default()('https://images-api.nasa.gov/search?q=&nasa_id=' + id);
...
(function () {
  ...
  reactHotLoader.register(galleriaTheme, 'galleriaTheme', '/Users/shannon.rivers/Projects/GLOBE-Media_Gallery/next-boilerplate/pages/media.js');
...
//# sourceMappingURL=4.f9364b214690a87f1b39.hot-update.js.map